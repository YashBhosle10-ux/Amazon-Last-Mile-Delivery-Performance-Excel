# Amazon-Last-Mile-Delivery-Performance-Excel

Project Summery - Excel dashboard analyzing Amazon last-mile delivery performance. Cleaned raw data using Power Query and created KPIs for on-time delivery, average delay, and speed. Built pivot tables and charts to analyze performance by area, traffic conditions, and vehicle type.

# Amazon Last-Mile Delivery Performance Analysis (Excel Dashboard)
...
## 📸 Screenshots
![Dashboard view 1](Screenshots/Screenshot%20(549).png)
![Dashboard view 2](Screenshots/Screenshot%20(550).png)
